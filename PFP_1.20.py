#/# Basic GAT NN for prediction of TUDataset PROTEINS
...
step = 0
writer = SummaryWriter("runs/Prot/Comp(1.20)(36)/") #def tensorboard storage path
...
class GCN(nn.Module): #/#
    def __init__(self):
        super().__init__()
        self.conv1 = GATConv(dataset.num_node_features, 128) ###dont condense bc no point rn
