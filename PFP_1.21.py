#/# Basic GAT NN for prediction of TUDataset PROTEINS (GATv2)
...
from torch_geometric.nn import GCNConv, GraphConv, GATConv, GATv2Conv
...
step = 0
writer = SummaryWriter("runs/Prot/Comp(1.21(60))/") #def tensorboard storage path
...
class GCN(nn.Module): #/#
    def __init__(self):
        super().__init__()
        self.conv1 = GATv2Conv(dataset.num_node_features, 128) ###dont condense bc no point rn
