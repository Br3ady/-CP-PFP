...
step = 0
writer = SummaryWriter("runs/Prot/Comp(1.1)/") #def tensorboard storage path
...
train_L = DataLoader(train_S, batch_size = 26) #auto-structure data and def per/draw
test_L = DataLoader(test_S, batch_size = 26)
